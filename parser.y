...
/*  tokens  */
%token  IF ELSE WHILE FOR FUNCTION RETURN BREAK CONTINUE AND OR NOT LOCAL TRUE FALSE NIL ESCAPE QUASI_QUOTES_OPEN QUASI_QUOTES_CLOSE QUASI_STMTS
%token  <numVal> NUMBER 
...
funcdef:        FUNCTION '('  idlist ')' block                  {
                ...
                | FUNCTION id '(' idlist ')' block              {
                                                                    ...
                                                                    obj->childrenTags.push_back(AST_TAG_ID);
                                                                    obj->childrenTags.push_back(AST_TAG_IDLIST);
...
ifstmt:         IF '(' expr ')' stmt                            {
                ...
                | IF '(' expr ')' stmt ELSE stmt                {
                                                                    ...
                                                                    obj->childrenTags.push_back(AST_TAG_EXPR);
                                                                    obj->childrenTags.push_back(AST_TAG_IF_STMT);
                                                                    obj->childrenTags.push_back(AST_TAG_ELSE_STMT);
                                                                    $$ = new Value(*obj);
                                                                }
                ;
...
forstmt:        FOR '(' elist ';' expr ';' elist ')' stmt       {
                                                                    ...
                                                                    obj->childrenTags.push_back(AST_TAG_INIT);
                                                                    obj->childrenTags.push_back(AST_TAG_EXPR);
                                                                    obj->childrenTags.push_back(AST_TAG_FORCOND);
                                                                    obj->childrenTags.push_back(AST_TAG_FORSTMT);
                                                                    $$ = new Value(*obj);
                                                                }
                ;
...
QuasiQuotes:    QUASI_QUOTES_OPEN QUASI_STMTS stmts QUASI_QUOTES_CLOSE      {
